...
app.get("/false_mirror", (req, res) => {
  res.sendFile(path.join(__dirname, "static/FalseMirror.html"));
});

app.get("/graffiti", (req, res) => {
  res.sendFile(path.join(__dirname, "static/graffiti.html"));
});

app.get("/LHOOQ", (req, res) => {
  res.sendFile(path.join(__dirname, "static/LHOOQ.html"));
});
