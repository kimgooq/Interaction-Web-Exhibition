...
class OrbitControls extends EventDispatcher {
  constructor(object, domElement) {
    ...
    ///////////////////////////////////////
    //this.minPolarAngle = Math.PI / 3; // radians * 1/3
    //this.maxPolarAngle = Math.PI / 1.5; // radians * 2/3
    this.minPolarAngle = (Math.PI * 1) / 3;
    this.maxPolarAngle = (Math.PI * 2) / 3;

    // How far you can orbit horizontally, upper and lower limits.
    // If set, the interval [ min, max ] must be a sub-interval of [ - 2 PI, 2 PI ], with ( max - min < 2 PI )
    // this.minAzimuthAngle = -Math.PI / 1.5; // radians
    // this.maxAzimuthAngle = Math.PI / 1.5; // radians
